...
public class CustomerController {
    ...
    @Log(title = "客户列表-导出", businessType = BusinessType.SELECT)
    ...
    @Log(title = "保存或更新客户", businessType = BusinessType.SELECT)
    ...
    @Log(title = "删除客户信息", businessType = BusinessType.SELECT)
    ...
    @Log(title = "转为公海客户", businessType = BusinessType.SELECT)
    ...
    @Log(title = "领取客户", businessType = BusinessType.SELECT)
